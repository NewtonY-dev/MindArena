...
export default function AdminManageQuestions() {
  ...
  const [selectedSource, setSelectedSource] = useState(''); // 'practice', 'contest', or ''
  ...
  useEffect(() => {
    filterQuestions();
  }, [selectedGrade, selectedSubject, selectedDifficulty, selectedSource, questions]);
  ...
  const filterQuestions = () => {
    ...
    if (selectedSource) {
      filtered = filtered.filter(q => q.usedInContests === (selectedSource === 'contest'));
    }
                ...
                <div key={question.id} className="question-card">
                  <div className="card-header">
                    <div className="card-badges">
                      ...
                      {question.used_in_contests && (
                        <span className="contest-badge" title="Used in contests">
